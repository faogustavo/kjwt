...
class JwkKeyConversionTest {
    ...
    @Test
    fun oct_toHmacKey_roundTrip() = runTest {
    ...
    @Test
    fun oct_missingPrivateKeyMaterial_alwaysPrivate() = runTest {
    ...
    @Test
    fun rsa_pkcs1_publicKey_conversionAndVerify() = runTest {
    ...
    @Test
    fun rsa_pkcs1_missingCrtParams_throwsOnConversion() = runTest {
    ...
    @Test
    fun ec_publicKey_conversion_rejectsBadDer() = runTest {
    ...
    @Test
    fun ec_p256_signAndVerifyRoundTrip() = runTest {
    ...
    @Test
    fun ec_missingPrivateD_throwsOnConversion() = runTest {
