...
class JwkSerializationTest {
    ...
    @Test
    fun keyOps_serializedWithUnderscore() {
    ...
    @Test
    fun rfcAppendixA1_ecPublicKeys() {
        val jwksJson = """
            {
              "keys": [
                {
